...
$\sigma_\omega / \omega = 0.6 \%$. This small error is linked to the constant rotational speed 
...
Plots of the measured data and the maxima can be found in the appendix. 
