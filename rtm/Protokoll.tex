...
\addcontentsline{toc}{section}{Bibliographie und Abbildungsverzeichnis}
\bibliographystyle{plain}
\bibliography{Protokoll}
\listoffigures

\input{anhang}
%\input{anhang_source_code}
% anhang_source_code muss mit pdflatex -shell-escape Protokoll.tex aufgerufen 
\end{document}
