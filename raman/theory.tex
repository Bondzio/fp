...
\end{equation}
with the unit vector $\textbf{n} = \frac{\textbf{R}}{R}$. We can use this knowledge for 
generalization.
...
Let us assume an incoming plain wave 
\begin{equation}
...
\end{equation}
with the classical fields $A$ and $\phi$. The dipole approximation uses the fact, that
