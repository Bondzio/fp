...
\textbf{Raman active}. Let us come back to the polarizability. Analogous to~\eqref{eq:I} the intensity of a fixed
...
\begin{equation}
    \text{mean radius: } \frac{1}{3}\mathrm{Tr}(\alpha) = \frac{1}{3}(\alpha_{xx} +\alpha_{yy}+ \alpha_{zz})
\end{equation}
