...
volume we will give an compact introduction to Raman spectroscopy, both from theoretical and experimental aspects. When 
Chandrasekhara Raman discovered the effect named after him later in 1928, he was not aware of the vast space of possibilities,
which would arise from this discovery. Through inelastic interaction with an atom or molecule light scatters with a different
frequency than before. Even though this effect is orders of magnitude smaller than scattering in the same frequency, it can
be used to determine properties of the object scattered at.
