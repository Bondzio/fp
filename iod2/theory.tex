...
\begin{eqnarray}
    ...
    \Delta S \ = \ 0
\end{eqnarray}
where $\Sigma$ is the eigenvalue of the total electron spin operator 
projected onto the axis of rotational symmetry, which is just the 
molecule axis, g is the 
