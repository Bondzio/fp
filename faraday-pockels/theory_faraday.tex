...
1828 by William Nicol. Its essentially a rhombohedral crystal of iceland spar with a 69° cut with
...
\begin{align}
    \sqrt{R^2 + x^2} \cos(\theta) &= R \\
    \Rightarrow dB_x &= dB \cos\theta = dB \left (\frac{R}{\sqrt{R^2 + x^2}} \right) = 
    \frac{\mu_0}{4\pi} \frac{I  \cdot R \cdot dl}{\sqrt{\left (R^2 + x^2 \right )^3}} \\
    B_x &= \frac{\mu_0}{4\pi} \frac{I  \cdot R}{\sqrt{\left (R^2 + x^2 \right )^3}} \int_C dl 
    = \frac{\mu_0}{4\pi} \frac{I  \cdot R}{\sqrt{\left (R^2 + x^2 \right )^3}} \left (2\pi R \right )
\end{align}
