...
def plot_data2(name, title):
    T,U2 = read_data2(name)
    plt.plot(T*1000,U2, label = "Voltage at photodiode" )
    plt.title(title)
    plt.xlabel("time $t/ ms$")
    plt.ylabel("Voltage $U/ V$")
...
def plot_25():
    for i in range(1,5 + 1):
        plot_data2("2.5_laser%02d"%i, "Oscilloscope  2.5 Laser $%02d$"%(i))
    plot_data2("2.5_no_laser01", "Oscilloscope  2.5 Laser 01")
