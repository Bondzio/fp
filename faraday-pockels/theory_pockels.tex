...
We follow the deduction given by~\ref{landau1984electrodynamics}.
If we define the 
...
\emph{internal conical refraction}~\ref{landau1984electrodynamics}. 
\FloatBarrier
...
\begin{equation}
    ...
    \label{eq:pertubed}  
\end{equation}
For reasonably small fields, we can expand
...
\eqref{eq:pertubed}. We resume the most important results:
\begin{itemize}
    \item
