...
Another characterization of crystals can be done by the point groups. 
...
with one point group. We again obtain seven point groups. As higher symmetries 
imply lower ones (e.~g. $4/m 2/m 2/m$ implies $2/m$), the lower 
symmetries often apply to several systems. However, a the identification 
...
Point groups can further be illustrated by their \emph{stereographic projections}, 
...
\begin{figure}[h]
    ...
    \caption{
        \ref{fig:stereo_1}:
            Crystal at the center of the sphere for the stereographic 
            projection with points of intersections, here shown for 
            galena (PbS).
        \ref{fig:stereo_2}:
            Construction of the stereographic projection with the 
            plane of projection and south pole.
        \ref{fig:stereo_3}:
            Result of stereographic projection for PbS. The lines 
            show the interconnection great circles projected on the plane. 
            All figrues taken from ~\cite{borchardt1995crystallography}.}
    \label{fig:stereo}
\end{figure}
