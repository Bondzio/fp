...
\end{equation*}
Since the cross-section take the form \eqref{eq:breitwigner}, we can calculate the maximum with
\begin{equation*}
    \sigma_f^{\mathrm{peak}} = \frac{12\pi \Gamma_e \Gamma_f \Gamma_e}{M_Z^2 \Gamma_Z^2}
\end{equation*}
